...
public class SqlQueryiesProgram {
	...
	static void insertStatements(){
		
		String sql = "insert into eet_tb_persoon(voornaam,achternaam) values(\"Frederik\",\"Rotsaert\")" ;
		
		try(Connection con = getConnection()){
			Statement st = con.createStatement();		
			int changed = st.executeUpdate(sql);
